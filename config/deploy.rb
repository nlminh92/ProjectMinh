...
set :deploy_to,       "/home/#{fetch(:user)}/websites/#{fetch(:application)}"
...
#set :ssh_options,     { forward_agent: true, user: fetch(:user), auth_methods: %w(publickey), keys: %w(/home/leminh/.ssh/id_rsa) }
